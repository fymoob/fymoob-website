...
description: "Lista dos documentos pra comprar imóvel em Curitiba em 2026, organizada pelos 5 órgãos emissores. 9 Ofícios de Registro, certidão municipal que trava escritura e prazos reais de validade."
date: "2026-01-15"
...
1. **Portal único da Prefeitura** ([cnd-cidadao.curitiba.pr.gov.br](https://cnd-cidadao.curitiba.pr.gov.br)) desde 29/03/2021 — todas as certidões municipais num só lugar, grátis, sem visitar o portal GTM antigo.
2. **CNIB 2.0** (Sistema de Indisponibilidade do CNJ) implantado em 2023 — bloqueio de matrícula agora é **por imóvel específico**, não mais genérico sobre todo o patrimônio do devedor. Mais fácil identificar e resolver.
3. **Provimento CNJ 149/2023** consolidou e expandiu o e-Notariado — hoje todos os tabelionatos de notas de CWB oferecem a modalidade.
4. **CND unificada** Receita Federal + PGFN — 1 certidão só, 180 dias, desde 2014 (prática já consolidada em 2026).
...
3. Matrícula atualizada no RI correto (consultar CEP na AMEP)
4. Certidão Negativa de Imóveis (Prefeitura)
5. Certidão de Débitos Tributários do CPF/CNPJ do vendedor
6. Certidões TJ-PR (feitos cíveis, criminais, distribuição)
7. Certidão de Protesto

**Semana 3 — banco + cartório:**

8. Matrícula em mãos → envia ao banco (financiado) ou direto ao tabelionato
9. Se e-Notariado: agenda videoconferência
10. Emite guia ITBI → paga → tabelião lavra escritura

**Semana 4 — registro:**

11. Leva escritura + ITBI pago ao RI da circunscrição
12. Matrícula atualizada em seu nome → emite nova certidão pra arquivo
...
<Changelog
  entries={[
    {
      date: "2026-04-23",
      description: "Reestruturação completa. Organização por 5 órgãos emissores (não por tipo de parte). Correção de '8 zonas' para '9 Ofícios'. e-Notariado reposicionado como opcional. Base legal LGPD corrigida (execução de contrato, não consentimento). Links para fontes primárias (Planalto, CNJ, AMEP, Prefeitura)."
    }
  ]}
/>
