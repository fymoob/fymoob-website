...
| 4 | Bom Retiro | +9,1% | R$ 10.623 | Infra nova + pipeline pequeno |
...
**Bom Retiro (R$ 10.623, +9,1%)** entrega o melhor custo-benefício do cluster. Pipeline de lançamentos pequeno, sem saturação, proximidade com Passeio Público e Parque São Lourenço. Subiu quase um ponto e meio acima do índice de Curitiba.
...
**Bacacheri (R$ 8.680, +5,1%)** é o clássico do cluster. Bairro familiar por definição, IDEB 6,7 nas escolas públicas, parque linear, aeroclube. Não surpreende — consistente.
