...
## Yield observado em fechamentos recentes

A conta do yield (aluguel × 12 ÷ venda) em Curitiba muda bastante por bairro, e os agregados genéricos ("0,5-0,7%/mês") escondem essa diferença. Abaixo o yield medido em fechamentos reais acompanhados pela FYMOOB em abril/2026, onde tivemos amostra suficiente (≥3 aluguéis e ≥3 vendas no mesmo bairro no mês):

| Bairro | m² venda | m² aluguel | Yield/mês | Yield/ano | Amostra |
|---|---|---|---|---|---|
...
**Leitura honesta:** Xaxim com 13,4% a.a. é outlier estatístico — amostra pequena, provavelmente puxada por studio mobiliado específico. Use como **indicativo**, não como regra do bairro. Cidade Industrial e Campo de Santana, com yield 4-5% a.a., são as leituras mais robustas.

Pra bairros de alto ticket (Batel, Bigorrilho, Mossunguê, Água Verde), o yield médio pedido pelo mercado de locação em 2026 está entre 0,28% e 0,38% ao mês (~3,4% a 4,6% a.a.) conforme [Secovi-PR](https://secovi-pr.com.br/) e [FipeZap Locação](https://www.fipe.org.br/pt-br/indices/fipezap/). Bairros premium costumam render menos em aluguel — são store of value, não renda.
...
<MethodologyBox
  ...
  treatment="Ranking de venda usa FipeZap como fonte primária, cruzado com Quinto Andar Index e Secovi-PR. Yield calculado como (aluguel médio × 12) ÷ venda média por bairro, com amostra mínima de 3 aluguéis e 3 vendas no mesmo bairro no mês de referência. Bairros com amostra menor aparecem como indicativos."
...
<Changelog entries={[
  { date: "2026-04-24", change: "Publicação da reescrita completa. Dados FipeZap mar/2026 + yield observado em fechamentos FYMOOB no mês." }
]} />
