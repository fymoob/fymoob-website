...
export default function MorarEmCuritibaPage() {
  ...
  const breadcrumbItems = [
    { name: "Home", url: "/" },
    { name: "Morar em Curitiba", url: "/morar-em-curitiba" },
  ]

  const relatedLinks = [
    { label: "Custo de Vida em Curitiba 2026", href: "/blog/custo-de-vida-curitiba" },
    ...
    { label: "Alugar em Curitiba", href: "/alugar-curitiba" },
    { label: "Batel vs Água Verde", href: "/blog/batel-vs-agua-verde-curitiba" },
      ...
      <article className="mx-auto max-w-4xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <header className="mt-6">
          <div className="flex items-center gap-3 text-sm text-neutral-500">
            <span className="rounded-full bg-blue-100 px-3 py-1 text-xs font-medium text-blue-700">Guia Completo</span>
        ...
        <div className="mt-12 border-t border-neutral-200 pt-8">
          <DynamicFAQ questions={generatePillarFAQ("morar")} title="Perguntas frequentes sobre morar em Curitiba" />
        </div>
