      ...
      <div className="-mx-4 -mt-6 border-b border-slate-200 bg-white px-4 py-4 sm:-mx-6 sm:-mt-8 sm:px-6 lg:-mx-10 lg:-mt-10 lg:px-10 2xl:-mx-12 2xl:px-12 dark:border-admin-border dark:bg-admin-surface">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <Link
              href="/admin/blog"
              className="inline-flex items-center gap-1 text-sm text-slate-500 hover:text-brand-primary dark:text-slate-400 dark:hover:text-brand-primary"
            >
              <ChevronLeft size={14} />
              Artigos
            </Link>
...
function DropdownMenu({
  ...
  return (
    <details className="relative">
      <summary className="cursor-pointer list-none rounded-lg border border-slate-200 bg-white px-3 py-1.5 text-xs font-medium text-slate-700 hover:border-brand-primary dark:border-admin-border dark:bg-admin-surface dark:text-slate-200 dark:hover:border-brand-primary">
        Mais ▾
      </summary>
      <div className="absolute right-0 top-full z-30 mt-1 w-44 overflow-hidden rounded-lg border border-slate-200 bg-white shadow-lg dark:border-admin-border dark:bg-admin-surface dark:shadow-black/40">
        <button
          type="button"
          onClick={onDuplicate}
          className="flex w-full items-center gap-2 px-3 py-2 text-left text-xs text-slate-700 hover:bg-slate-50 dark:text-slate-200 dark:hover:bg-admin-elevated"
        >
        ...
        <button
          type="button"
          onClick={onArchive}
          className="flex w-full items-center gap-2 border-t border-slate-100 px-3 py-2 text-left text-xs text-red-600 hover:bg-red-50 dark:border-admin-border dark:text-red-400 dark:hover:bg-red-950/30"
        >
