    ...
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        <Breadcrumbs
          items={[
            { name: "Home", url: "/" },
            { name: "Terrenos em Curitiba", url: "/terrenos-curitiba" },
          ]}
        />
        ...
        <div className="mt-6">
          <p className="max-w-3xl text-fymoob-gray-mid">
            Terrenos à venda em Curitiba para construir o imóvel dos seus sonhos. A FYMOOB
            oferece terrenos em diversos bairros, com diferentes metragens e condições
            de pagamento.
          </p>
        </div>

        {bairrosComTerreno.length > 0 && (
          <div className="mt-6 flex flex-wrap gap-2">
            {bairrosComTerreno.map((b) => (
              <Link
                key={b.slug}
                href={`/imoveis/${b.slug}/terrenos`}
