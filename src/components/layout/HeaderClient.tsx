    ...
    <>
      ...
      >
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 md:h-16 lg:px-8">
          ...
          {/* WhatsApp + Quick Menu + Phone CTA + Mobile Menu */}
          <div className="flex items-center gap-3 sm:gap-4">
            <a
              href="https://wa.me/5541999780517?text=Ol%C3%A1!%20Gostaria%20de%20mais%20informa%C3%A7%C3%B5es%20sobre%20os%20im%C3%B3veis%20da%20FYMOOB."
              target="_blank"
              ...
              className={cn(
                ...
                isTransparent
                  ...
                  : "text-[#25D366] hover:bg-neutral-100 hover:text-[#1da851]"
              )}
            >
