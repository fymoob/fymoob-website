...
export function WhatsAppFloat() {
  ...
  useEffect(() => {
    ...
    // On property pages, hide when MobileContactBar is visible (scroll > 400)
  ...
  return (
    <a
      ...
      className={`fixed bottom-20 right-4 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-all duration-300 hover:scale-110 md:bottom-6 md:right-6 ${
        hidden ? "translate-y-24 opacity-0 pointer-events-none md:translate-y-0 md:opacity-100 md:pointer-events-auto" : ""
      }`}
    >
