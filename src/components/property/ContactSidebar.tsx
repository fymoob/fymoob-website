  ...
  return (
    <Card
      className={cn(
        ...
        isPremium
          ? "border-white/10 bg-white/[0.98] shadow-[0_28px_70px_rgba(15,23,42,0.18)]"
    ...
    >
      <CardContent className="px-6 py-7">
        ...
        <div className="mb-5">
          ...
          <div className="mt-1.5 flex items-baseline gap-1.5">
            <p
              className={cn(
                ...
                isPremium ? "text-[2rem] font-semibold" : "text-3xl font-bold"
              )}
            >
          ...
          {!isPremium && (isRental || isDual) && (valorCondominio || valorIptu) && (
            <div className="mt-3 space-y-1.5 border-t border-neutral-100 pt-3">
        ...
        <div className="mb-6 grid grid-cols-2 gap-3">
          <a
            ...
            className={cn(
              "flex h-11 w-full items-center justify-center gap-2 rounded-xl text-sm font-semibold text-white transition-colors",
              isPremium
        ...
        >
          {isPremium && (
            <p className="text-sm leading-relaxed text-slate-500">
              Atendimento consultivo com retorno rápido pelo WhatsApp ou telefone.
            </p>
          )}
          <Input
            type="text"
