...
export function PropertyCardFeatured({ property }: PropertyCardFeaturedProps) {
  ...
  return (
    <Link
      ...
      className="group flex flex-col overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-lg transition-all duration-300 hover:-translate-y-1 hover:border-brand-primary-muted hover:shadow-xl md:min-h-[350px] md:flex-row"
    >
      {/* Image */}
