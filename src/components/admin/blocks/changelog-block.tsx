              ...
              {entries.map((e, idx) => (
                ...
                >
                  <input
                    ...
                    className="rounded-md border border-amber-200 bg-white px-2 py-1.5 text-xs text-slate-900 focus:border-amber-400"
                  />
                  <input
                    type="text"
                    value={e.change}
                  ...
                  <button
                    ...
                    className="rounded-md p-1.5 text-amber-900/70 hover:bg-amber-100 hover:text-red-600"
                  >
                    <Trash2 size={12} />
                  </button>
                </li>
